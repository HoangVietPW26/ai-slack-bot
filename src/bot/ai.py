...
OPENAI_API_KEY = config.env("OPENAI_API_KEY", default=None)
UPSTASH_VECTOR_URL = config.env("UPSTASH_VECTOR_URL", default=None)
UPSTASH_VECTOR_TOKEN= config.env("UPSTASH_VECTOR_TOKEN", default=None)
